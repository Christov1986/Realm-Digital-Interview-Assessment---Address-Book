...
public class Addressbook_Update_PhoneNumber_Menu implements ActionListener{
	//Declare and instantiate instance variables
	JFrame frame = new JFrame("ADDRESS BOOK - UPDATE PHONE NUMBER MENU");
	JLabel updatePhoneMenu = new JLabel("UPDATE PHONE NUMBER MENU", SwingConstants.CENTER);
	JLabel updatePhoneMenuInstruction = new JLabel("Select the Phone ID to be updated and enter the Phone Number", SwingConstants.CENTER);
	...
	// Create Delete GUI
	public void updatePhoneFrameGUI() {
		// Set Frame
        ...
        updatePhoneMenu.setBounds(200, 0, 800, 20);
        updatePhoneMenuInstruction.setBounds(50, 20, 1100, 20);
        textPhoneID.setBounds(435, 50, 150, 30);
        textPhoneNumber.setBounds(615, 50, 150, 30);
        valuePhoneID.setBounds(435, 80, 150, 30);
        valuePhoneNumber.setBounds(615, 80, 150, 30);
        updatePhoneNumber.setBounds(875, 80, 275, 30);
        scrollPane.setBounds(50, 120, 1100, 320);
        executeSelectAll.setBounds(50, 450, 1100, 40);
        mainMenu.setBounds(50, 500, 1100, 40);
        
        // Add buttons to frame
        frame.add(updatePhoneMenu);
        frame.add(updatePhoneMenuInstruction);
        frame.add(textPhoneID);
        frame.add(textPhoneNumber);
        frame.add(valuePhoneID);
        frame.add(valuePhoneNumber);
        frame.add(updatePhoneNumber);
        ...
        updatePhoneNumber.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource() == updatePhoneNumber) {
			String sqlQuery = ("UPDATE phone_no SET Phone_number='" + valuePhoneNumber.getText()
					+ "' WHERE phone_id=" + valuePhoneID.getText());
