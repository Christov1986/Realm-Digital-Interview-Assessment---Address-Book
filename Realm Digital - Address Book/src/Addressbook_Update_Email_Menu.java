...
public class Addressbook_Update_Email_Menu implements ActionListener{
		//Declare and instantiate instance variables
		JFrame frame = new JFrame("ADDRESS BOOK - UPDATE E-MAIL MENU");
		JLabel updateEmailMenu = new JLabel("UPDATE E-MAIL MENU", SwingConstants.CENTER);
		JLabel updateEmailMenuInstruction = new JLabel("Select the Email ID to be updated and enter the E-mail Address", SwingConstants.CENTER);
		...
		JButton updateEmailAddress = new JButton("UPDATE E-MAIL ADDRESS");
		...
		// Create Delete GUI
		public void updateEmailFrameGUI() {
			// Set Frame
	        ...
	        updateEmailAddress.addActionListener(this);
		...
		public void actionPerformed(ActionEvent e) {
			...
			else if(e.getSource() == updateEmailAddress) {
				String sqlQuery = ("UPDATE email SET Email='" + valueEmailAddress.getText()
						+ "' WHERE email_id=" + valueEmailID.getText());
